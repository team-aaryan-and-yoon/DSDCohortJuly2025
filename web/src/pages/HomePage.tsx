...
const HomePage = () => {
  ...
  const services: serviceType[] = [
    {
      ...
      description:
        "A thorough cleaning service covering all your needs from single rooms to entire houses. Our professional cleaners ensure spotless results every time.",
      details: "",
      image_url: "/images/cleaning.png",
      reviews: [],
    },
    {
      name: "Maintenance",
      ...
      description:
        "Comprehensive maintenance services including repairs, installations, yard work, and general handyman work. Our skilled technicians can handle any home maintenance task.",
      details: "",
      image_url: "/images/handyman.png",
      reviews: [],
    },
  ];
  const reviews: reviewType[] = [
    {
      reviewer: "John S",
      comment: "The best cleaning service in town!",
      rating: 5,
    ...
    <div className="w-full h-full bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div
            className={`grid md:grid-cols-2 lg:grid-cols-${services.length} gap-8`}>
