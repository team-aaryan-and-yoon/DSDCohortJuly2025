...
const LandingPage = () => {
  const services = [
    {
      icon: Hammer,
      title: "Furniture & Home Repairs",
      description: "Expert fixing and maintenance for all your home needs",
    },
    {
      icon: Zap,
    ...
    },
    {
      icon: Droplets,
      title: "Plumbing",
      description: "Professional plumbing services from leaks to installations",
    },
    {
      icon: Paintbrush,
      title: "Painting",
    ...
    },
    {
      icon: Star,
      title: "Cleaning",
      description: "Thorough and reliable cleaning services for your home",
    },
  ];
  ...
  const testimonials = [
    {
      name: "Sarah Johnson",
      rating: 5,
      text: "Exceptional service! Fixed my kitchen sink perfectly and on time.",
    },
    {
      name: "Mike Chen",
      rating: 5,
      text: "Professional, reliable, and fair pricing. Highly recommend!",
    },
    {
      name: "Emma Davis",
      rating: 5,
      text: "Great attention to detail. My bathroom renovation looks amazing.",
    },
  ];
      ...
      <section className="py-20 bg-blue-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Join thousands and millions of satisfied customers who trust
            HandsOff for all their Handy needs.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              size="lg"
              variant="outline"
              className="text-lg px-8 py-6 text-blue-500 border-white hover:bg-gray-200 hover:text-blue-600"
            >
              Get Free Quote
            </Button>
          </div>
