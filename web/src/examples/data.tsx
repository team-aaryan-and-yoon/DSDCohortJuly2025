...
const cleaningServiceData: serviceType[] = [
  ...
  },
  {
    ...
    img_url: cleaningImage,
    details:
      "This service cleans your room with a fast speed and better quality",
    reviews: [],
  },
  {
    name: "Service 4",
    ...
    img_url: cleaningImage,
    details:
      "This service cleans your room with a extremely fast speed and best quality",
    reviews: [],
  },
];
...
const maintenanceServiceData: serviceType[] = [
  ...
  },
  {
    ...
    img_url: cleaningImage,
    details:
      "This service maintains your home with a fast speed and better quality",
    reviews: [],
  },
  {
    name: "Service 4",
